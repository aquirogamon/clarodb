class Ppmcachegoogle < ActiveRecord::Base

  serialize :ppmcachegoogles_array
  ...
  def self.devint
    ...
    #interface_array = CSV.read(Rails.root + "public/cache_prueba.csv")[1..-1]
  end
  ...
  def self.statsinterfacemax_table
   ...
   devint.each do |devint|
    ...
    data_stats = transport_stats(devint[1])["report"]["data"]

class Ppmroute < ActiveRecord::Base
  ...
  def self.route_summary
    ...
    base_url = "https://#{ENV["PPM_CREDENTIALS"]}@172.19.212.8:4440/ppm/rest/reports/IP+Protocols/Route+Summary/IP+Route+Summary?outputType=json&durationSelect=lastDay&intervalTypeKey=QUARTER_HOUR&maxPageSize=200000000"

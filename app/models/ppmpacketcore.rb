class Ppmpacketcore < ActiveRecord::Base

  serialize :ppmpacketcores_array
  ...
  def self.transport_stats(ip_address)
    ...
    base_url = "https://aquiroga:Cl4r0peru51@172.19.212.8:4440/ppm/rest/reports/Transport+Statistics/Interface/Interface+Bit+Rates?outputType=jsonv2&durationSelect=lastDay&intervalTypeKey=FIVE_MINUTE&maxPageSize=20000000" + fqdn
    begin
  ...
  def self.devint
    interface_array = CSV.read(Rails.root + "public/core_mobile.csv")[1..-1]
  end

class Ppminterfacecore < ActiveRecord::Base

  serialize :ppminterfacecores_array
  ...
  def self.interface_table_core(interfaces_file)
    interfaces_file = 'core_sem26'
   ...
   data = Hash.new { |hash, key| hash[key] = [] }
    ...
    data_tests = Ppminterfacecore.transport_stats(device[1])
    unless data_tests == nil
      data[device[0]] = Ppminterfacecore.transport_stats(device[1])["report"]["data"]
